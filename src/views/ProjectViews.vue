            ...
            <div class="wrapper">
                <div class="tittle">
                    <h1>
                        projetos
                        <br>
                        <svg xmlns="http://www.w3.org/2000/svg" width="90" height="99" viewBox="0 0 110 119" fill="none">
                ...
                <div class="projects-container">
                    ...
                    <ProjectsSlide :projectsProps="projects" :showRightProps="showRight" :showLeftProps="false"></ProjectsSlide>
    ...
    methods: {
        ...
        verifyCurrentCountPosition(){
            ...
            if(this.count >= (this.projects.length - 3)){
                this.currentTranslate = 0 - (333 * amount / 4) + 166.5
                slide.style.transition = '0s'
                slide.style.transitionDuraction = '0s'
                console.log("funcionou?", slide.style.transition)
                this.doubleArray()
