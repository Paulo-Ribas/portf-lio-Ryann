            ...
            <div class="wrapper">
                <div class="tittle">
                    <h1>
                        ...
                        <br>
                        mim
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="109" viewBox="0 0 110 119" fill="none">
                ...
                <div class="description-container">
                    <p>
                        Meu nome é Ryann Ghisi, tenho 17 anos e sou um Web Designer e Designer Gráfico. <br> Ingressei na área de design com o objetivo de aprimorar minhas habilidades empreendedoras e adquirir competências técnicas sólidas. Ao longo do tempo, desenvolvi experiência em design gráfico e web design, tornando-me capaz de criar designs funcionais e esteticamente agradáveis. Meu foco principal é atender às necessidades práticas dos meus clientes. Estou à disposição para auxiliá-lo na criação de designs para aplicativos, websites, logos e outros projetos relacionados ao design. Se precisar dos meus serviços ou quiser discutir colaborações, sinta-se à vontade para entrar em <RouterLink to="/contact">contato</RouterLink>.
                    </p>
                </div>
            </div>
        </div>
